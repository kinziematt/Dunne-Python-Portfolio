...
# * **Bonus:** Go above and beyond and "wow" your classmates (and me!) by looking into matplotlib widgets and adding a widget 
...
# PLOT HISTOGRAM OF FOUR DIFFERENT DISTIBUTIONS SIDE BY SIDE IN ONE CHART
...
plt.savefig('Histogram Distribution Plot.png')