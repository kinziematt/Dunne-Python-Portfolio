...
# STRING MANIPULATION, RESET INDEX
...
# GROUPBY AND CALCULATE, RESET INDEX, SORT, SUBSET, CONVERT TO DATETIME, MERGE, CALCULATE ACROSS COLUMNS
...
# LINE PLOT WITH FILL BETWEEN, SET LABELS, SET TICKS, SET TITLE, SAVE TO FILE
